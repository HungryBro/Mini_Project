...
# หากวิดีโอไม่มีข้อความเวลา หรือต้องการระบุเวลาเริ่มต้นเอง สามารถใส่สตริง เช่น "2026-09-01 15:45:00" ได้
TIMESTAMP_112 = None

# สำหรับ live_stream: สามารถระบุเวลาจำลองเองเพื่อทดสอบระบบตารางทิศทางเลนและรถย้อนศรได้
# เช่น ใส่สตริง "2026-09-01 15:45:00" เพื่อบังคับจำลองช่วงเวลาเร่งด่วนเย็น
# หากเป็น None จะใช้เวลาปัจจุบันของเครื่อง (System Clock) สำหรับ live_stream
LIVE_STREAM_OVERRIDE_TIME = None
