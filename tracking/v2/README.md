...
ByteTrack ดิบ: รถต้องข้ามเส้น Wrong-Way Gate ในทิศสวนเลน แล้วเคลื่อนต่อเนื่อง
หลังเส้นตามค่าที่ตั้งใน `settings.py` จึงถูกนับครั้งเดียว วิธีนี้ตัดการแจ้งผิด
จากกล่องตรวจจับสั่นหรือรถที่เพิ่งปรากฏไกลด้านบนภาพ
